...
const Cards = () => {
  ...
  <button className='bg-[#38b38c] w-[200px] rounded-md font-medium
        my-6 mx-auto px-6 py-3 text-black'>Strat Trial</button>
  </div>
  ...
  <button className='bg-black w-[200px] rounded-md font-medium
        my-6 mx-auto px-6 py-3 text-[#38b38c]'>Strat Trial</button>
  </div>
